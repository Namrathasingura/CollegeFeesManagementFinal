...
if(isset($_POST['search']))
{
    ...
    $query="SELECT * FROM `tblstudent`  WHERE email= '".$valuesearch."' or fname= '".$valuesearch."' or mname= '".$valuesearch."' or lname= '".$valuesearch."' or type= '".$valuesearch."' or quota= '".$valuesearch."'";
                            ...
                            <div class="panel-body">
                                <div class="table-sorting table-responsive">
                                    ...
                                    <form action="" method="post" id="formnotes">
                                        <div id="tSortable22_length" class="dataTables_length"><input name="valuesearch"  type="text"  id="valuesearch" placeholder="Enter the Email"/></label></div>
